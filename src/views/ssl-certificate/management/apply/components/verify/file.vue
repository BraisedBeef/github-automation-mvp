  ...
  <div class="tpl-container">
    ...
    <el-steps class="steps" direction="vertical">
      ...
      <el-step class="step-item">
        ...
        <template #title>
          <p class="step-title">
            {{ t('ssl-certificate.management.apply.verify.778200-13') }}
          </p>
        </template>
        <template #description>
          <p class="step-description">
            {{ t('ssl-certificate.management.apply.verify.778200-14') }}
          </p>
          <el-form-item>
            <el-button
            ...
            >
              {{ t('ssl-certificate.management.apply.verify.778200-16') }}
            </el-button>
          </el-form-item>
          <TipsBar
