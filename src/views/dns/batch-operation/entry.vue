<template>
  ...
  <LegacyBatchOperation v-else />
</template>

<script setup lang="ts">
import LegacyBatchOperation from './batch-operation.vue'
import V2BatchOperation from '@/views/v2/dns/batch-operation/batch-operation.vue'
