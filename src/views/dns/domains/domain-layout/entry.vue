...
import LegacyDomainLayout from '../domain-layout.vue'
import V2DomainLayout from '@/views/v2/dns/domains/domain-layout.vue'
...
const currentComponent = computed(() => (isV2Theme.value ? V2DomainLayout : LegacyDomainLayout))
