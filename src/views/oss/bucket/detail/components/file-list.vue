    ...
    <div class="df jsb">
      <div class="btn-wrap mr20">
        ...
        <template v-if="ossStore.folders.length === 0">
          <el-badge style="margin: 0 10px" is-dot :hidden="!showFragmentManagementDot">
      ...
      <div class="search-wrap df mb20">
        <div>
          ...
          >
            <template #prepend>
              <el-select v-model="search.searchType" :style="`width: 172px; background: #fff`">
            ...
            <template #suffix>
              ...
              />
              <div class="ml10" />
              <SvgIcon style="cursor: pointer" name="dns-search" @click="searchFiles()" />
            </template>
          </el-input>
        </div>
