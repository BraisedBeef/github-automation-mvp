<template>
  <V2AccountPageShell v-if="isV2Theme">
    <V2ResourcePackCreate />
  </V2AccountPageShell>
  <LegacyResourcePackCreate v-else />
</template>

<script setup lang="ts">
import LegacyResourcePackCreate from './index.vue'
import V2ResourcePackCreate from '@/views/v2/oss/resource-pack/create/index.vue'
