...
import LegacyRoleDetail from './index.vue'
import V2RoleDetail from '@/views/v2/account-system/access/role-detail/index.vue'
...
const currentComponent = computed(() => (isV2Theme.value ? V2RoleDetail : LegacyRoleDetail))
