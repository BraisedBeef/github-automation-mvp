...
import LegacyRoleList from './index.vue'
import V2RoleList from '@/views/v2/account-system/access/role-list/index.vue'
...
const currentComponent = computed(() => (isV2Theme.value ? V2RoleList : LegacyRoleList))
