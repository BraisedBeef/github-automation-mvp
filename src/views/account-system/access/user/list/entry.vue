...
import LegacyUserList from './index.vue'
import V2UserList from '@/views/v2/account-system/access/user-list/index.vue'
...
const currentComponent = computed(() => (isV2Theme.value ? V2UserList : LegacyUserList))
