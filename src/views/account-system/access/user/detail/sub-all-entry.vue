...
import LegacySubAllDetail from './sub-all-detail.vue'
import V2SubAllDetail from '@/views/v2/account-system/access/user-detail/sub-all/index.vue'
...
const currentComponent = computed(() => (isV2Theme.value ? V2SubAllDetail : LegacySubAllDetail))
