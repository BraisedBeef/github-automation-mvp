...
import LegacyStrategyDetail from './index.vue'
import V2StrategyDetail from '@/views/v2/account-system/access/strategy-detail/index.vue'
...
const currentComponent = computed(() => {
  return isV2Theme.value ? V2StrategyDetail : LegacyStrategyDetail
})
