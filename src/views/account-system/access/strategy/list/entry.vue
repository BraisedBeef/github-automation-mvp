...
import LegacyStrategyList from './index.vue'
import V2StrategyList from '@/views/v2/account-system/access/strategy-list/index.vue'
...
const currentComponent = computed(() => {
  return isV2Theme.value ? V2StrategyList : LegacyStrategyList
})
