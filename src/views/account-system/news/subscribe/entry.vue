...
import LegacySubscribe from './index.vue'
import V2Subscribe from '@/views/v2/account-system/news/subscribe/index.vue'
...
const currentComponent = computed(() => {
  return isV2Theme.value ? V2Subscribe : LegacySubscribe
})
