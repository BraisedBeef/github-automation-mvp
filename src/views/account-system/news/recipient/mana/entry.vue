...
import LegacyRecipientMana from './index.vue'
import V2RecipientMana from '@/views/v2/account-system/news/recipient-mana/index.vue'
...
const currentComponent = computed(() => {
  return isV2Theme.value ? V2RecipientMana : LegacyRecipientMana
})
