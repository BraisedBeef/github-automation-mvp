...
import LegacyRecipientList from './index.vue'
import V2RecipientList from '@/views/v2/account-system/news/recipient-list/index.vue'
...
const currentComponent = computed(() => {
  return isV2Theme.value ? V2RecipientList : LegacyRecipientList
})
