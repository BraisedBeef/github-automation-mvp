<template>
  ...
  >
    <el-form ref="mobileFormRef" require-asterisk-position="right" :model="form">
      <el-form-item label="" required prop="loginProtect" :label-width="formLabelWidth" class="dialog-form-item">
        <p class="form-item-info">
          {{ t('securitySetting.loginProtectionInstructions') }}
        </p>
        <div class="form-item-radio">
          <el-radio-group v-model="form.loginProtect">
            <div>
              <el-radio :label="0">
