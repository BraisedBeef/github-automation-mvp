<template>
  <div class="dns-monitor-list">
    ...
    <div class="content-handle">
      ...
      <!-- 搜索框 -->
      <div class="content-handle-right">
        <el-input
      ...
      >
        <template #default="{ row, $index }">
          ...
          <div v-else-if="item.prop === 'status'" class="table-status h-full">
            ...
            <span :class="row.status === 1 ? 'successStatus' : 'errorStatus'">{{
...
.dns-monitor-list {
  ...
  :deep(.account-table-v2__table .el-table-column--selection .cell) {
    padding: 0;
  }
}
