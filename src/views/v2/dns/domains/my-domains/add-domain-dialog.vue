<template>
  ...
  >
        ...
        >
          ...
          >
            <el-input
              ...
              class="add-domain-dialog__input"
              :placeholder="t('myDomains.addDomainPlaceholder')"
            />
          </el-form-item>

          <!-- Type1: tip提示 -->
          <template v-if="state.type === 1 && validateErr.name">
    ...
    <!-- 按钮 -->
    <template #footer>
      <div class="cat-dialog-footer add-domain-dialog__footer">
        <!-- 1.添加域名 -->
...
.content {
  ...
  :deep(.add-domain-dialog__form) {
    ...
    .el-form-item.is-error .el-input__wrapper {
      box-shadow: 0 0 0 1px #fe4d4f inset !important;
    }
...
<style lang="scss">
.add-domain-dialog-v2.cat-dialog {
  padding: 0;
  ...
  .add-domain-dialog__footer .el-button {
    min-width: 76px;
  ...
  .add-domain-dialog__footer .el-button:first-child {
    margin-left: 0;
  }
}
</style>
