<template>
  <V2AccountPageShell v-if="isV2Theme">
    <V2ExpenseBillDownload />
  </V2AccountPageShell>
  <LegacyExpenseBillDownload v-else />
</template>

<script setup lang="ts">
import LegacyExpenseBillDownload from './index.vue'
import V2ExpenseBillDownload from '@/views/v2/cost-center/expense-bill/download/index.vue'
