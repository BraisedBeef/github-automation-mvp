<template>
  ...
  <LegacyExpenseBillList v-else />
</template>

<script setup lang="ts">
import LegacyExpenseBillList from './index.vue'
import V2ExpenseBillList from '@/views/v2/cost-center/expense-bill/bill/list/index.vue'
