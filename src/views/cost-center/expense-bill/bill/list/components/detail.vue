  ...
  <div class="wrap">
    ...
    <div class="mb20 list-wrap page-box">
      ...
      <el-table v-loading="loading" :data="list" class="mt20 table" show-overflow-tooltip>
        <!-- 资源id/实例别名 -->
        <el-table-column prop="resourceId" min-width="250">
          <template #header>
        ...
        <el-table-column prop="billingMode" min-width="200">
          ...
          <template #default="{ row }">
            <span>{{ COST_TYPE_MAP[row.billingMode] }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="transactionType" min-width="200">
          ...
          <template #default="{ row }">
            <span>{{ TRANSACTION_TYPE_MAP[row.transactionType] }}</span>
          </template>
        </el-table-column>
        <!-- 订单id -->
        <el-table-column prop="subTradeNo" min-width="300">
          <template #header>
            <div class="table-header">
              <span>{{ t('bill.tradeNo') }}</span>
              <el-tooltip :content="t('bill.tradeNoTooltip')" placement="top" popper-class="table-header_tooltip">
                <el-icon class="table-header_icon">
                  <SvgIcon name="cat-cdn-warning" />
                </el-icon>
              </el-tooltip>
          ...
          <template #default="{ row }">
            <span>{{ row.subTradeNo || '-' }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="billId" min-width="300">
          <template #header>
            <div class="table-header">
              <span>{{ t('bill.billId') }}</span>
              <el-tooltip :content="t('bill.billIdTooltip')" placement="top" popper-class="table-header_tooltip">
                <el-icon class="table-header_icon">
                  <SvgIcon name="cat-cdn-warning" />
                </el-icon>
              </el-tooltip>
        ...
        <!-- 配置描述 -->
        <el-table-column prop="mainDescription" min-width="300">
          <template #header>
            <div class="table-header">
        ...
        <!-- 组件名称 -->
        <el-table-column prop="componentName" min-width="200">
          <template #header>
            <div class="table-header">
        ...
        <el-table-column prop="unitPrice" min-width="200">
          <template #header>
            <div class="table-header">
              <span>{{ t('bill.unitPrice') }}</span>
              <el-tooltip :content="t('bill.unitPriceTooltip')" placement="top" popper-class="table-header_tooltip">
                <el-icon class="table-header_icon">
                  <SvgIcon name="cat-cdn-warning" />
                </el-icon>
              </el-tooltip>
        ...
        <!-- 价格单位 -->
        <el-table-column prop="unit" min-width="200">
          <template #header>
            <div class="table-header">
        ...
        <el-table-column prop="used" min-width="200">
          <template #header>
            <div class="table-header">
        ...
        <!-- 用量单位 -->
        <el-table-column prop="usedUnit" min-width="200">
          <template #header>
            <div class="table-header">
        ...
        <el-table-column prop="usedDuration" min-width="200">
          <template #header>
            <div class="table-header">
        ...
        <!-- 时长单位 -->
        <el-table-column prop="usedDurationUnit" min-width="200">
          <template #header>
            <div class="table-header">
          ...
          <template #default="{ row }">
            <span>{{ row.usedDurationUnit }}</span>
          </template>
        </el-table-column>
        <!-- 原价 -->
        ...
        <!-- 赠送金支付 -->
        <el-table-column prop="giftGoldMoney" min-width="200">
          <template #header>
            <div class="table-header">
        ...
        <!-- 平台垫付 -->
        <el-table-column prop="platformAdvancePaymentMoney" min-width="210">
          <template #header>
            <div class="table-header">
          ...
          <template #default="{ row }">
            {{ row.platformAdvancePaymentMoney }}
          </template>
        </el-table-column>
        <!-- 现金支付 -->
...
const incomeSerialNo = route.query.incomeSerialNo as string // 收支明细流水号
...
const tips = computed(() => [
  {
    main: t('bill.detailTip1'),
    sub: [t('bill.detailTip2'), t('bill.detailTip3')],
  },
])
