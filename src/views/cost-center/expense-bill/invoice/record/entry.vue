<template>
  <V2AccountPageShell v-if="isV2Theme">
    <V2ExpenseBillInvoiceRecord />
  </V2AccountPageShell>
  <LegacyExpenseBillInvoiceRecord v-else />
</template>

<script setup lang="ts">
import LegacyExpenseBillInvoiceRecord from './index.vue'
import V2ExpenseBillInvoiceRecord from '@/views/v2/cost-center/expense-bill/invoice/record/index.vue'
