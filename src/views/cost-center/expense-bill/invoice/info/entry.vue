<template>
  <V2AccountPageShell v-if="isV2Theme">
    <V2ExpenseBillInvoiceInfo />
  </V2AccountPageShell>
  <LegacyExpenseBillInvoiceInfo v-else />
</template>

<script setup lang="ts">
import LegacyExpenseBillInvoiceInfo from './index.vue'
import V2ExpenseBillInvoiceInfo from '@/views/v2/cost-center/expense-bill/invoice/info/index.vue'
