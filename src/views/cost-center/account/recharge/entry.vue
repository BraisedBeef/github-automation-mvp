<template>
  <V2AccountPageShell v-if="isV2Theme">
    <V2CostCenterAccountRecharge />
  </V2AccountPageShell>
  <LegacyCostCenterAccountRecharge v-else />
</template>

<script setup lang="ts">
import LegacyCostCenterAccountRecharge from './index.vue'
import V2CostCenterAccountRecharge from '@/views/v2/cost-center/account/recharge/index.vue'
