<template>
  <V2AccountPageShell v-if="isV2Theme">
    <V2CostCenterAccountInfo />
  </V2AccountPageShell>
  <LegacyCostCenterAccountInfo v-else />
</template>

<script setup lang="ts">
import LegacyCostCenterAccountInfo from './index.vue'
import V2CostCenterAccountInfo from '@/views/v2/cost-center/account/info/index.vue'
