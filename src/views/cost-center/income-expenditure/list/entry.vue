<template>
  <V2AccountPageShell v-if="isV2Theme">
    <V2IncomeExpenditureList />
  </V2AccountPageShell>
  <LegacyIncomeExpenditureList v-else />
</template>

<script setup lang="ts">
import LegacyIncomeExpenditureList from './index.vue'
import V2IncomeExpenditureList from '@/views/v2/cost-center/income-expenditure/list/index.vue'
