 ...
 */
export function filterArray<T extends object>(arr: T[], key: keyof T, value?: number | string | boolean): T | undefined
export function filterArray<T extends object>(arr: T[], key: keyof T, value?: (number | string | boolean)[]): T[]
